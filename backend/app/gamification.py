...
class GamificationModels:
    ...
    class UserBadge(Base):
        ...
        # Achievement context
        # JSON data about what triggered the badge
...
class GamificationEngine:
    ...
    def award_xp(self, user_id: int, activity: str,
        ...
        self.logger.info(
            f"Awarded {xp_amount} XP to user {user_id} for {activity}")
    ...
    def _update_user_xp(self, user_id: int, xp_amount: int) -> bool:
        ...
        while progress.total_xp >= progress.xp_to_next_level:
            ...
            progress.xp_to_next_level = int(
                self.level_xp_formula(
    ...
    def check_and_award_badges(
        ...
        for badge_type, badge_def in self.badge_definitions.items():
            ...
            if self._check_badge_requirements(
                    user_id, badge_def, activity_context):
    ...
    def get_user_stats(self, user_id: int) -> Dict:
        ...
        return {
            ...
            "study_time_hours": round(
                progress.total_study_time_minutes / 60,
                1),
    ...
    def process_review_activity(
        ...
        activity = "card_review_correct" if review_result.get(
            "correct") else "card_review_incorrect"

        # Build context for XP multipliers
        context = {
            "first_try": review_result.get(
                "attempts",
                1) == 1,
